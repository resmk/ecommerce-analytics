...
# Load root .env (so DASH_API_BASE_URL works)
...
app.layout = html.Div(
    ...
    children=[
        html.Div(
            ...
            children=[
                html.H1("E-Commerce Analytics Dashboard", style={"marginBottom": "8px"}),
                html.Div("Overview (API-driven)", style={"opacity": 0.7, "marginBottom": "16px"}),
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        dcc.Interval(id="refresh", interval=60_000, n_intervals=0),  # every 60s
                    ],
                ),
